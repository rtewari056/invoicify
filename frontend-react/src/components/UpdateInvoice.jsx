  ...
  const handleSearch = (e) => {
    if (e.target.value === "") {
      ...
      if(filterResult.length > 0) {
        ...
        setData([{"id": "Not found"}]); // If not found anything
      }
    }
      ...
      <div className="row">
        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div className="table-responsive">
            <table className="table custom-table m-0 text-center">
              <thead>
                <tr>
                  <th>id</th>
                  <th>title</th>
              ...
              <tbody>
                {data.map((element, index) => {
                  return (
                    <tr key={`product-${index}`} style={{ border: "none" }}>
                      <td>{element.id}</td>
                      <td>{element.title}</td>
                      ...
                      <td>
                        <button
                          type="button"
                          className="btn btn-primary btn-sm my-1 me-2"
                        >
                          Update <i className="fas fa-edit ms-1" />
                        </button>
                        <button
                          type="button"
                          className="btn btn-danger btn-sm my-1"
                        >
                          Delete <i className="fas fa-trash-alt ms-1" />
                        </button>
                      </td>
                    </tr>
                  );
